      ...
      <div className="container">
        ...
        <div className={styles.about__inner}>
          <div className={`${styles.about__info} ${darkModeClass}`}>
            <p>
              Компания &quot;BoilersHouse&quot; предлагает Вам запасные части
            ...
            <p>
              Ассортимент интернет-магазина &quot;BoilersHouse&quot; включает в
          ...
          <div className={`${styles.about__img} ${styles.about__img__top}`}>
            <img src="/img/about-img.png" alt="изображение о компании 1" />
          </div>
          <div className={`${styles.about__img} ${styles.about__img__bottom}`}>
            <img src="/img/about-img-2.png" alt="изображение о компании 2" />
          </div>
        </div>
      </div>
    </section>
